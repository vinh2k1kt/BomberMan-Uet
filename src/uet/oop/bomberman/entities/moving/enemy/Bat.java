...
public class Bat extends Character {
    ...
    public Bat(double xUnit, double yUnit, Image img, Level level) {
    ...
    public void update() {
        ...
        if (alive) {
            ...
            for (Player bomber : level.bombers) {
                this.collisionChecker.Kill(bomber);
                if (level.bombers.isEmpty()) {
                    randomDirection();
                }
            }
    ...
    private void chooseSprite() {
        ...
        switch (currentDirection) {
            case LEFT, UP -> this.img = Animation.batLeftAni.get(index).getFxImage();
            case RIGHT, DOWN -> this.img = Animation.batRightAni.get(index).getFxImage();
        }
    }
